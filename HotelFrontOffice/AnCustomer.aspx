...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="IblError" runat="server" style="z-index: 1; left: 61px; top: 329px; position: absolute" Text="[IblError]"></asp:Label>
        <asp:CheckBox ID="Active" runat="server" style="z-index: 1; left: 64px; top: 284px; position: absolute; height: 27px;" />
