...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblSupplierFirstName" runat="server" style="z-index: 1; left: 58px; top: 166px; position: absolute; height: 19px; right: 665px;" Text="Supplier First Name"></asp:Label>
        ...
        <asp:CheckBox ID="Active" runat="server" style="z-index: 1; left: 56px; top: 403px; position: absolute" Text="Active" />
