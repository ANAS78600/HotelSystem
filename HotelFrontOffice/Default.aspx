...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label runat="server" style="z-index: 1; left: 67px; top: 295px; position: absolute; width: 223px; height: 30px;" Text="Please Enter First Name"></asp:Label>
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 63px; top: 373px; position: absolute; height: 31px; width: 86px" Text="Apply" OnClick="btnApply_Click" />
